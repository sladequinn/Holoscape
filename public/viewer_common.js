...
export async function initViewer() {
    ...
    scene.add(light);
    console.log("initViewer: Light added to the scene.");
    ...
    camera = new THREE.PerspectiveCamera(70, window.innerWidth / window.innerHeight, 0.1, 2000);
     ...
     camera.lookAt(0, 0, 0);
    scene.add(camera);
    console.log("initViewer: Camera added to the scene.");
    ...
    // Check if there is an error in the renderer context
     const gl = renderer.getContext();
      const glError = gl.getError();
       if (glError !== gl.NO_ERROR){
           console.error("initViewer: WebGL Context Error:", glError);
       }
   ...
   console.log("initViewer: Renderer added to DOM.");
